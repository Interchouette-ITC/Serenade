...
/// [`RegisterDefaultMailerPass`] / [`RegisterDefaultHttpClientPass`] so apps
/// resolve `mailer` and `http_client` unless they replace them. The root config,
/// event dispatcher, and console application are registered by
