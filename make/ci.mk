...
COVERAGE_FEATURES := --features serenade-cache/redis,serenade-lock/redis,serenade-messenger/redis,serenade-serializer/toon,serenade-scheduler/messenger
...
doc:
	cd $(ROOT) && RUSTDOCFLAGS="$(RUSTDOCFLAGS)" $(CARGO) doc --workspace --no-deps --features serenade-cache/redis,serenade-lock/redis,serenade-messenger/redis,serenade-serializer/toon,serenade-scheduler/messenger
